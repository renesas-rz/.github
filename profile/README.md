<img src="https://github.com/renesas-rz/.github/blob/main/banner2.png" style="width: 100%; height: 100%; object-fit: fill;">

# Renesas Repositories for RZ Microprocessors 

### 🐧 Linux BSP Repos
* Information Page 👉 [link](https://github.com/renesas-rz/.github/blob/main/README_BSP.md)
* Links to Repositories used for building the BSP image including Kernel, u-boot, Yocto, Graphics Libraries, etc...

<HR>

### 🧠 Vision Artificial Intelligence
* RZ/V BSP Download and Build Instructions 👉 [AI SDK](https://renesas-rz.github.io/rzv_ai_sdk/latest/)
...
* Renesas RZ Linux Solutions Information 👉 [link](https://renesas-rz.github.io/rz_solution/)
* Renesas Official RZ MPU Device Website 👉 [link](https://www.renesas.com/en/products/microcontrollers-microprocessors/rz-mpus)
* Wiki site containing detailed technical information 👉 [link](https://renesas-wiki.atlassian.net/wiki/spaces/REN/overview)
